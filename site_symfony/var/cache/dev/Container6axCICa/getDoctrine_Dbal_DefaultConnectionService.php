...
return $this->services['doctrine.dbal.default_connection'] = (new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory(array()))->createConnection(array('dbname' => $this->getEnv('DATABASE_NAME'), 'host' => '127.0.0.1', 'port' => 3306, 'user' => $this->getEnv('DATABASE_USER'), 'password' => $this->getEnv('DATABASE_PWD'), 'driver' => 'pdo_mysql', 'charset' => 'utf8mb4', 'driverOptions' => array(), 'serverVersion' => '5.7', 'defaultTableOptions' => array('charset' => 'utf8mb4', 'collate' => 'utf8mb4_unicode_ci')), $a, $c, array());
